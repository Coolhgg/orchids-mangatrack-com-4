...
import { Star, Users, Calendar, Share2, MoreHorizontal, ExternalLink, Globe, User, Loader2 } from "lucide-react"
...
export default async function SeriesDetailPage({
  ...
  try {
    ...
    const { cn, sanitizePrismaObject } = await import('@/lib/utils')
